...
namespace Groceries.Droid
{
    public class ListRowCustomAdapter : BaseAdapter<GroceryListClass>
    {
        ...
        public ListRowCustomAdapter(Activity context, List<GroceryListClass> inpLists)
        {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            string subtext = curLists[position].Items.Count + " for " + curLists[position].Owner.Name;
